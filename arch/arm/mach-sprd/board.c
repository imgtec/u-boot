...
#include <asm/io.h>
#include <asm/arch-sprd/boot_mode.h>
#include <asm/arch-sprd/clock.h>
#include <asm/arch-sprd/periph.h>
#include <asm/arch-sprd/misc.h>
...
int board_usb_init(int index, enum usb_init_type init)
{
	...
	otg_data.regs_phy =  offset +
		(u32)syscon_get_first_range(SPRD_SYSCON_GRF);
#endif
...
int fastboot_set_reboot_flag(enum fastboot_reboot_reason reason)
{
	...
	writel(BOOT_FASTBOOT, CONFIG_SPRD_BOOT_MODE_REG);
